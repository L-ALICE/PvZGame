var CPlants = NewO({
    ...
    Die: function(a) {
        ...
        b.HP = 0;
        delete $P[c];
        delete oGd.$[b.R + "_" + b.C + "_" + b.PKind]; ! a && ClearChild($(c));
        b.PrivateDie(b)
    }
}),
...
oGarlic = InheritO(CPlants, {
    ...
    getHurt: function(e, b, a) {
        var c = this,
        d = $(c.id).childNodes[1]; ! (b % 3) ? (c.HP -= 20) < 1 ? c.Die() : (c.ChangeR(c, e), c.HP < 134 ? c.HurtStatus < 2 && (c.HurtStatus = 2, d.src = "images/Plants/Garlic/Garlic_body3.gif") : c.HP < 267 && c.HurtStatus < 1 && (c.HurtStatus = 1, d.src = "images/Plants/Garlic/Garlic_body2.gif")) : c.Die(1)
    },
